...
from login.forms import EmployeeForm  ,AboutForm ,ContactForm ,DonateForm ,BlogForm ,CauseForm ,ServiceForm ,ActivityForm ,PartnerForm ,MemberForm ,LoginForm
from login.models import Employee  ,About  ,Contact ,Blog ,Donation ,Cause ,Service ,Activity ,Partner ,Member 
