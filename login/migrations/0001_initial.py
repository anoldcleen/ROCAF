# Generated by Django 3.2.12 on 2023-10-24 10:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Amount1', models.CharField(blank=True, default='', max_length=100)),
                ('Amount2', models.CharField(blank=True, default='', max_length=100)),
                ('Amount3', models.CharField(blank=True, default='', max_length=100)),
                ('Amount4', models.CharField(blank=True, default='', max_length=100)),
                ('Amount5', models.CharField(blank=True, default='', max_length=100)),
                ('Amount6', models.CharField(blank=True, default='', max_length=100)),
                ('status1', models.CharField(blank=True, default='', max_length=100)),
                ('status2', models.CharField(blank=True, default='', max_length=100)),
                ('status3', models.CharField(blank=True, default='', max_length=100)),
                ('status4', models.CharField(blank=True, default='', max_length=100)),
                ('status5', models.CharField(blank=True, default='', max_length=100)),
                ('status6', models.CharField(blank=True, default='', max_length=100)),
                ('genderequity', models.CharField(blank=True, default='', max_length=100)),
                ('skills', models.CharField(blank=True, default='', max_length=100)),
                ('education', models.CharField(blank=True, default='', max_length=100)),
                ('climatechange', models.CharField(blank=True, default='', max_length=100)),
                ('livelihoods', models.CharField(blank=True, default='', max_length=100)),
                ('sustainabledevelopment', models.CharField(blank=True, default='', max_length=100)),
            ],
            options={
                'db_table': 'about',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('servicecategory', models.CharField(blank=True, default='', max_length=50)),
                ('servicetitle', models.CharField(blank=True, default='', max_length=50)),
                ('servicedescription1', models.TextField(blank=True, default='')),
